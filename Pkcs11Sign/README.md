...
This kit contains the Pkcs11Sign sample for Pdftools SDK for Java. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
3. Right-click the file containing the `main` method and select **Run 'PdfToolsPkcs11Sign'**.
...
### Using Gradle
  ...
  ```bash
  gradle build
  ./gradlew run --args="<pkcs11Library> <password> <certificate> <inputPath> <outputPath>"
  ```
